...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, "ittc/templates"),
)
...
CUSTOM_STATS = [
    ...
    {'name': 'by_minute', 'collection': 'stats_by_minute', 'attributes': ['minute'], 'window': {'minutes':60}},
    ...
    {'name': 'by_hour_origin', 'collection': 'stats_by_hour_origin', 'attributes': ['hour', 'origin'], 'window': {'hours':24}},
    {'name': 'by_minute_origin', 'collection': 'stats_by_minute_origin', 'attributes': ['minute', 'origin'], 'window': {'minutes':60}},
    {'name': 'by_date_source', 'collection': 'stats_by_date_source', 'attributes': ['date', 'source']},
    {'name': 'by_hour_source', 'collection': 'stats_by_hour_source', 'attributes': ['hour', 'source'], 'window': {'hours':24}},
    {'name': 'by_minute_source', 'collection': 'stats_by_minute_source', 'attributes': ['minute', 'source'], 'window': {'minutes':60}},
